  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn("text-sm font-medium capitalize", isDropdown && "hidden"),
        caption_dropdowns: "flex justify-center gap-2",
        dropdown: "bg-background border border-input rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-ring cursor-pointer capitalize",
